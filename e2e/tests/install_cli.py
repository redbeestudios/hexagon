...
aliases_file_path = os.path.realpath(os.path.join(__file__, os.path.pardir, os.path.pardir, 'install_cli', 'home-aliases.txt'))
...
def test_install_cli():
  ...
  assert_process_output(process, [
    ...
    '[79C[0;38;5;240m│[0m',
    '[0;38;5;240m│[0;38;5;75m❯[0;38;5;180m [0;38;5;75m⬡ Install CLI                                               Install a custom',
    '[79C[0;38;5;240m│[0m',
    '[0;38;5;240m└──────────────────────────────────────────────────────────────────────────────',
    '[79C┘[0m',
  ])
  ...
  assert_process_output(process, [
    '[0m [3A[3C[?7h[0m[?12l[?25h[?25l[?7l[2A[3D[0m[J[0;38;5;180m?[0m Hi, which tool would you like to use today?[0;38;5;75m ⬡ Install CLI',
    '[79C',
    '[0m',
    '[J[?7h[0m[?12l[?25h[?2004l[?2004h[?1l[?25l[0m[?7l[0m[J[0;38;5;180m?[0m Where is your project\'s hexagon config file? [0;38;5;108m',
    '[79C/[0m',
    '[0;38;5;108minstall_cli[0m',
  ])
  discard_output(process, 5)
  write_to_process(process, f'/config.yml\n')
  discard_output(process, 4)
  assert_process_output(process, [
